...
<center>![](images/r.jpeg){fig-align="center" width="100"} <br> ![](images/sf_logo.gif){fig-align="center" width="100"}</center>
:::
...
![](images/DUOC_logo.png){fig-align="center" width="100"} ![](images/geocoding.png){fig-align="center" width="300"}
:::
...
::: {.column .p_small width="45%"}
![](images/back_homev04-1.png){fig-align="center" width="600"}![](images/logo-mbht.png){fig-align="right" width="120" #right}
:::
::::::
...
## Relaciones de Nivel Socioeconómicos con Delitos
...
1.  De direcciones a coordenadas para análisis geoespacial.
2.  De puntos a densidades con KDE para identificar patrones de distribución.
3.  De ráster a polígonos para construir indicadores territoriales.
...
# Preguntas {background-image="images/automatizacion-de-reportes-con-r-web.jpeg" background-size="100%" background-position="center"}
...
![](images/denis_circle.png){fig-align="center" width="600"}
:::

::: {.column width="10%"}
:::

::: {.column .tex_center width="45%"}
...
<center>
###### **Denis Berroeta González** {.p_small_c}
</center>

 email:  <denis.berroeta@uai.cl>.  
 linkedin:  [denis-berroeta](https://www.linkedin.com/in/denis-berroeta/)

_Coordinador de Investigación Centro de Inteligencia Territorial UAI_.  PhD (c) en Ciencia de Datos FIC-UAI.  
...
- Repositorio de [Datos y Códigos](https://alumnosuaicl-my.sharepoint.com/:f:/g/personal/denis_berroeta_uai_cl/EjECaA5JPMVPhYMmbH4ExQ0BbULc6iCN1QKflFuhlvd0gQ?e=qSlTnu) usados en el Taller.
